...
#define VOLT_TEMP_SENSOR_4_Pin GPIO_PIN_0
#define VOLT_TEMP_SENSOR_4_GPIO_Port GPIOC
#define VOLT_TEMP_SENSOR_3_Pin GPIO_PIN_1
#define VOLT_TEMP_SENSOR_3_GPIO_Port GPIOC
#define VOLT_TEMP_SENSOR_1_Pin GPIO_PIN_2
#define VOLT_TEMP_SENSOR_1_GPIO_Port GPIOC
#define VOLT_TEMP_SENSOR_2_Pin GPIO_PIN_3
#define VOLT_TEMP_SENSOR_2_GPIO_Port GPIOC
#define VOLT_SENSOR_3_Pin GPIO_PIN_0
#define VOLT_SENSOR_3_GPIO_Port GPIOA
...
#define CURRENT_SENSOR_H_Pin GPIO_PIN_3
#define CURRENT_SENSOR_H_GPIO_Port GPIOA
#define BRAKE_PRESSURE_SENSOR_Pin GPIO_PIN_4
#define BRAKE_PRESSURE_SENSOR_GPIO_Port GPIOA
#define VOLT_SENSOR_4_Pin GPIO_PIN_5
#define VOLT_SENSOR_4_GPIO_Port GPIOA
#define VOLT_SENSOR_2_Pin GPIO_PIN_6
#define VOLT_SENSOR_2_GPIO_Port GPIOA
#define VOLT_TEMP_SENSOR_6_Pin GPIO_PIN_7
#define VOLT_TEMP_SENSOR_6_GPIO_Port GPIOA
#define VOLT_TEMP_SENSOR_5_Pin GPIO_PIN_4
#define VOLT_TEMP_SENSOR_5_GPIO_Port GPIOC
#define VOLT_SENSOR_1_Pin GPIO_PIN_5
#define VOLT_SENSOR_1_GPIO_Port GPIOC
#define CURRENT_SENSOR_L_Pin GPIO_PIN_0
#define CURRENT_SENSOR_L_GPIO_Port GPIOB
#define RIDE_HEIGHT_SENSOR_Pin GPIO_PIN_1
#define RIDE_HEIGHT_SENSOR_GPIO_Port GPIOB
