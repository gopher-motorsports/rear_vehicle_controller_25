...
#define INVERTER_FAN_THRESH_C    40.0f // Inverter temperature at which the cooling system turns on
#define MOTOR_FAN_THRESH_C       40.0f // Motor temperature at which the cooling system turns on
